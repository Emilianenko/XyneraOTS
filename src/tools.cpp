...
std::string getSpecialSkillName(uint8_t skillid)
{
	switch (skillid) {
		...
		case SPECIALSKILL_ONSLAUGHT:
			return "onslaught";

		case SPECIALSKILL_RUSE:
			return "ruse";

		case SPECIALSKILL_MOMENTUM:
			return "momentum";
...
std::map<SkillWheelAbilities_t, std::vector<SkillWheelAbilities_t>> wheelNeighbours;

std::vector<SkillWheelAbilities_t> getWheelNeighbours(SkillWheelAbilities_t wheelPos) {
	if (!wheelNeighbours.empty()) {
		return wheelNeighbours[wheelPos];
	}

	wheelNeighbours[SKILLWHEEL_STRAWBERRY_1] = { SKILLWHEEL_STRAWBERRY_2_TOP, SKILLWHEEL_STRAWBERRY_2_BOTTOM };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_2_TOP] = { SKILLWHEEL_STRAWBERRY_2_BOTTOM, SKILLWHEEL_STRAWBERRY_3_TOP, SKILLWHEEL_STRAWBERRY_3_MIDDLE, SKILLWHEEL_LIME_2_TOP };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_2_BOTTOM] = { SKILLWHEEL_STRAWBERRY_2_TOP, SKILLWHEEL_STRAWBERRY_3_MIDDLE, SKILLWHEEL_STRAWBERRY_3_BOTTOM, SKILLWHEEL_GRAPE_2_TOP };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_3_TOP] = { SKILLWHEEL_STRAWBERRY_2_TOP, SKILLWHEEL_STRAWBERRY_3_MIDDLE, SKILLWHEEL_STRAWBERRY_4_TOP, SKILLWHEEL_LIME_3_TOP };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_3_MIDDLE] = { SKILLWHEEL_STRAWBERRY_2_TOP, SKILLWHEEL_STRAWBERRY_2_BOTTOM, SKILLWHEEL_STRAWBERRY_3_TOP, SKILLWHEEL_STRAWBERRY_3_BOTTOM, SKILLWHEEL_STRAWBERRY_4_TOP, SKILLWHEEL_STRAWBERRY_4_BOTTOM };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_3_BOTTOM] = { SKILLWHEEL_STRAWBERRY_2_BOTTOM, SKILLWHEEL_STRAWBERRY_3_MIDDLE, SKILLWHEEL_STRAWBERRY_4_BOTTOM, SKILLWHEEL_GRAPE_3_TOP };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_4_TOP] = { SKILLWHEEL_STRAWBERRY_3_TOP, SKILLWHEEL_STRAWBERRY_3_MIDDLE, SKILLWHEEL_STRAWBERRY_4_BOTTOM, SKILLWHEEL_STRAWBERRY_5 };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_4_BOTTOM] = { SKILLWHEEL_STRAWBERRY_3_MIDDLE, SKILLWHEEL_STRAWBERRY_3_BOTTOM, SKILLWHEEL_STRAWBERRY_4_TOP, SKILLWHEEL_STRAWBERRY_5 };
	wheelNeighbours[SKILLWHEEL_STRAWBERRY_5] = { SKILLWHEEL_STRAWBERRY_4_TOP, SKILLWHEEL_STRAWBERRY_4_BOTTOM };

	wheelNeighbours[SKILLWHEEL_GRAPE_1] = { SKILLWHEEL_GRAPE_2_TOP, SKILLWHEEL_GRAPE_2_BOTTOM, };
	wheelNeighbours[SKILLWHEEL_GRAPE_2_TOP] = { SKILLWHEEL_GRAPE_2_BOTTOM, SKILLWHEEL_GRAPE_3_TOP, SKILLWHEEL_GRAPE_3_MIDDLE, SKILLWHEEL_STRAWBERRY_2_BOTTOM };
	wheelNeighbours[SKILLWHEEL_GRAPE_2_BOTTOM] = { SKILLWHEEL_GRAPE_2_TOP, SKILLWHEEL_GRAPE_3_MIDDLE, SKILLWHEEL_GRAPE_3_BOTTOM, SKILLWHEEL_MINT_2_BOTTOM };
	wheelNeighbours[SKILLWHEEL_GRAPE_3_TOP] = { SKILLWHEEL_GRAPE_2_TOP, SKILLWHEEL_GRAPE_3_MIDDLE, SKILLWHEEL_GRAPE_4_TOP, SKILLWHEEL_STRAWBERRY_3_BOTTOM, };
	wheelNeighbours[SKILLWHEEL_GRAPE_3_MIDDLE] = { SKILLWHEEL_GRAPE_2_TOP, SKILLWHEEL_GRAPE_2_BOTTOM, SKILLWHEEL_GRAPE_3_TOP, SKILLWHEEL_GRAPE_3_BOTTOM, SKILLWHEEL_GRAPE_4_TOP, SKILLWHEEL_GRAPE_4_BOTTOM };
	wheelNeighbours[SKILLWHEEL_GRAPE_3_BOTTOM] = { SKILLWHEEL_GRAPE_2_BOTTOM, SKILLWHEEL_GRAPE_3_MIDDLE, SKILLWHEEL_GRAPE_4_BOTTOM, SKILLWHEEL_MINT_3_BOTTOM };
	wheelNeighbours[SKILLWHEEL_GRAPE_4_TOP] = { SKILLWHEEL_GRAPE_3_TOP, SKILLWHEEL_GRAPE_3_MIDDLE, SKILLWHEEL_GRAPE_4_BOTTOM, SKILLWHEEL_GRAPE_5 };
	wheelNeighbours[SKILLWHEEL_GRAPE_4_BOTTOM] = { SKILLWHEEL_GRAPE_3_MIDDLE, SKILLWHEEL_GRAPE_3_BOTTOM, SKILLWHEEL_GRAPE_4_TOP, SKILLWHEEL_GRAPE_5 };
	wheelNeighbours[SKILLWHEEL_GRAPE_5] = { SKILLWHEEL_GRAPE_4_TOP, SKILLWHEEL_GRAPE_4_BOTTOM };

	wheelNeighbours[SKILLWHEEL_MINT_1] = { SKILLWHEEL_MINT_2_TOP, SKILLWHEEL_MINT_2_BOTTOM };
	wheelNeighbours[SKILLWHEEL_MINT_2_TOP] = { SKILLWHEEL_MINT_2_BOTTOM, SKILLWHEEL_MINT_3_TOP, SKILLWHEEL_MINT_3_MIDDLE, SKILLWHEEL_LIME_2_BOTTOM, };
	wheelNeighbours[SKILLWHEEL_MINT_2_BOTTOM] = { SKILLWHEEL_MINT_2_TOP, SKILLWHEEL_MINT_3_MIDDLE, SKILLWHEEL_MINT_3_BOTTOM, SKILLWHEEL_GRAPE_2_BOTTOM };
	wheelNeighbours[SKILLWHEEL_MINT_3_TOP] = { SKILLWHEEL_MINT_2_TOP, SKILLWHEEL_MINT_3_MIDDLE, SKILLWHEEL_MINT_4_TOP, SKILLWHEEL_LIME_3_BOTTOM };
	wheelNeighbours[SKILLWHEEL_MINT_3_MIDDLE] = { SKILLWHEEL_MINT_2_TOP, SKILLWHEEL_MINT_2_BOTTOM, SKILLWHEEL_MINT_3_TOP, SKILLWHEEL_MINT_3_BOTTOM, SKILLWHEEL_MINT_4_TOP, SKILLWHEEL_MINT_4_BOTTOM };
	wheelNeighbours[SKILLWHEEL_MINT_3_BOTTOM] = { SKILLWHEEL_MINT_2_BOTTOM, SKILLWHEEL_LIME_3_BOTTOM, SKILLWHEEL_MINT_4_BOTTOM, SKILLWHEEL_GRAPE_3_BOTTOM };
	wheelNeighbours[SKILLWHEEL_MINT_4_TOP] = { SKILLWHEEL_LIME_3_TOP, SKILLWHEEL_MINT_3_MIDDLE, SKILLWHEEL_MINT_4_BOTTOM, SKILLWHEEL_MINT_5 };
	wheelNeighbours[SKILLWHEEL_MINT_4_BOTTOM] = { SKILLWHEEL_MINT_3_MIDDLE, SKILLWHEEL_MINT_3_BOTTOM, SKILLWHEEL_MINT_4_TOP, SKILLWHEEL_MINT_5 };
	wheelNeighbours[SKILLWHEEL_MINT_5] = { SKILLWHEEL_MINT_4_TOP, SKILLWHEEL_MINT_4_BOTTOM };

	wheelNeighbours[SKILLWHEEL_LIME_1] = { SKILLWHEEL_LIME_2_TOP, SKILLWHEEL_LIME_2_BOTTOM };
	wheelNeighbours[SKILLWHEEL_LIME_2_TOP] = { SKILLWHEEL_LIME_2_BOTTOM, SKILLWHEEL_LIME_3_TOP, SKILLWHEEL_LIME_3_MIDDLE, SKILLWHEEL_STRAWBERRY_2_TOP };
	wheelNeighbours[SKILLWHEEL_LIME_2_BOTTOM] = { SKILLWHEEL_LIME_2_TOP, SKILLWHEEL_LIME_3_MIDDLE, SKILLWHEEL_LIME_3_BOTTOM, SKILLWHEEL_MINT_2_TOP };
	wheelNeighbours[SKILLWHEEL_LIME_3_TOP] = { SKILLWHEEL_LIME_2_TOP, SKILLWHEEL_LIME_3_MIDDLE, SKILLWHEEL_LIME_4_TOP, SKILLWHEEL_STRAWBERRY_3_TOP };
	wheelNeighbours[SKILLWHEEL_LIME_3_MIDDLE] = { SKILLWHEEL_LIME_2_TOP, SKILLWHEEL_LIME_2_BOTTOM, SKILLWHEEL_LIME_3_TOP, SKILLWHEEL_LIME_2_BOTTOM, SKILLWHEEL_LIME_4_TOP, SKILLWHEEL_LIME_4_BOTTOM };
	wheelNeighbours[SKILLWHEEL_LIME_3_BOTTOM] = { SKILLWHEEL_LIME_2_BOTTOM, SKILLWHEEL_LIME_3_MIDDLE, SKILLWHEEL_LIME_4_BOTTOM, SKILLWHEEL_MINT_3_TOP, };
	wheelNeighbours[SKILLWHEEL_LIME_4_TOP] = { SKILLWHEEL_LIME_3_TOP, SKILLWHEEL_LIME_3_MIDDLE, SKILLWHEEL_LIME_4_BOTTOM, SKILLWHEEL_LIME_5 };
	wheelNeighbours[SKILLWHEEL_LIME_4_BOTTOM] = { SKILLWHEEL_LIME_3_MIDDLE, SKILLWHEEL_LIME_3_BOTTOM, SKILLWHEEL_LIME_4_TOP, SKILLWHEEL_LIME_5 };
	wheelNeighbours[SKILLWHEEL_LIME_5] = { SKILLWHEEL_LIME_4_TOP, SKILLWHEEL_LIME_4_BOTTOM };
