...
class NpcEventsHandler
{
	public:
		...
		void onPlayerTrade(Player* player, int32_t callback, uint16_t itemId, uint8_t subType, uint16_t amount, bool ignore = false, bool inBackpacks = false);
...
class Npc final : public Creature
{
	public:
		...
		void onPlayerCloseChannel(Player* player);
		void onPlayerTrade(Player* player, int32_t callback, uint16_t itemId, uint8_t subType,
