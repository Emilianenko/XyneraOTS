...
enum item_t : uint16_t {
	...
	ITEM_FURNITURE_KIT = 26129,
	ITEM_STORE_KIT = 26054,
...
static constexpr int32_t PSTRG_MOUNTS_RANGE_SIZE = 100;
static constexpr int32_t PSTRG_MOUNTS_CURRENTMOUNT = (PSTRG_MOUNTS_RANGE_START + 999);
// [3001 - 3011];
