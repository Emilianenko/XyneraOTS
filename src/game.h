...
class Game
{
	public:
		...
		void playerRequestOutfit(uint32_t playerId, uint32_t otherCreatureId = 0, uint16_t lookType = 0, uint16_t lookMount = 0);
		...
		void playerBrowseStoreHistory(uint32_t playerId, uint32_t pageId, bool isInit);
