...
DISPATCHER_CYCLOPEDIA_BASE = 1
DISPATCHER_CYCLOPEDIA_GENERAL = 2
DISPATCHER_CYCLOPEDIA_COMBAT = 3
DISPATCHER_CYCLOPEDIA_DEATHS = 4
DISPATCHER_CYCLOPEDIA_PVPKILLS = 5
DISPATCHER_CYCLOPEDIA_ACHIEVEMENTS = 6
DISPATCHER_CYCLOPEDIA_INVENTORY = 7
DISPATCHER_CYCLOPEDIA_COSMETICS = 8
DISPATCHER_CYCLOPEDIA_STORE = 9
DISPATCHER_CYCLOPEDIA_INSPECTION = 10
DISPATCHER_CYCLOPEDIA_BADGES = 11
DISPATCHER_CYCLOPEDIA_TITLES = 12
DISPATCHER_FORGE_ENTER = 13
DISPATCHER_PAGINATION = 14
DISPATCHER_REFRESH_PAGINATION = 15
