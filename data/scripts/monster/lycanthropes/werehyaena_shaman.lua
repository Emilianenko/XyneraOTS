...
monster.attacks = {
    ...
    {name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2*1000, chance = 16, minDamage = -250, maxDamage = -350, radius = 4, target = true, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_GREEN_RINGS},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2*1000, chance = 14, minDamage = -300, maxDamage = -450, radius = 1, range = 5, target = true, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2*1000, chance = 12, minDamage = -280, maxDamage = -325, length = 3, spread = 0, effect = CONST_ME_MORTAREA, direction = true}
}
