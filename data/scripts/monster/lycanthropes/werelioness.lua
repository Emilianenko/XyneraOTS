...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 16, type = COMBAT_HOLYDAMAGE, minDamage = -300, maxDamage = -350, range = 5, effect = CONST_ME_HOLYAREA, shootEffect = CONST_ANI_SMALLHOLY, target = true},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -250, maxDamage = -350, length = 4, spread = 2, effect = CONST_ME_FIREAREA}
}
