...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 16, minDamage = 0, maxDamage = -170, range = 5, type = COMBAT_FIREDAMAGE, effect = CONST_ME_FIREATTACK, shootEffect = CONST_ANI_FIRE, target = true}, --flame strike
	...
	{name ="combat", interval = 2000, chance = 14, minDamage = 0, maxDamage = -250, length = 6, spread = 0, type = COMBAT_MANADRAIN, effect = CONST_ME_MAGIC_RED, direction = true}, --manadrain beam
	{name ="speed", interval = 2000, chance = 12, radius = 3, speed = -700, effect = CONST_ME_BLACKSMOKE, duration = 7000} --paralyze
