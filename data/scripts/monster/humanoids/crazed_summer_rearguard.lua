...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 18, minDamage = -220, maxDamage = -300, range = 6, radius = 3, type = COMBAT_FIREDAMAGE, shootEffect = CONST_ANI_FLAMMINGARROW, effect = CONST_ME_EXPLOSIONHIT, target = true}
}
