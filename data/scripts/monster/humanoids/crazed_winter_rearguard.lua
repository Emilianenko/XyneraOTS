...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 19, minDamage = -230, maxDamage = -300, range = 6, radius = 3, type = COMBAT_ICEDAMAGE, shootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_ICEATTACK, target = true}
}
