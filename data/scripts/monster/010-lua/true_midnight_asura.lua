...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 17, minDamage = -60, maxDamage = -290, length = 4, spread = 0, type = COMBAT_MANADRAIN, effect = CONST_ME_PURPLEENERGY, direction = true},
...
monster.defenses = {
	...
	{name ="invisible", interval = 2000, chance = 11, duration = 8000, effect = CONST_ME_MAGIC_BLUE}
}
