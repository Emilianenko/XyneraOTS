...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 22, minDamage = 0, maxDamage = -200, range = 4, type = COMBAT_PHYSICALDAMAGE, shootEffect = CONST_ANI_GREENSTAR, target = true},
	{name ="combat", interval = 2000, chance = 14, minDamage = -180, maxDamage = -240, range = 1, type = COMBAT_LIFEDRAIN, effect = CONST_ME_MAGIC_RED, target = true},
	{name ="combat", interval = 2000, chance = 17, minDamage = -200, maxDamage = -270, length = 5, spread = 3, type = COMBAT_MANADRAIN, effect = CONST_ME_MAGIC_RED, target = false, direction = true},
	-- {name ="drunk", interval = 2000, chance = 100, effect = CONST_ME_STUN, shootEffect = CONST_ANI_GLOOTHSPEAR, radius = 3, range = 4, target = true, duration = 10000},
	{name ="grimeleech wave", interval = 2000, chance = 20, minDamage = -450, maxDamage = -650, target = false, direction = true},
	{name ="combat", interval = 2000, chance = 24, minDamage = -320, maxDamage = -400, radius = 3, range = 4, type = COMBAT_DEATHDAMAGE, effect = CONST_ME_POFF, shootEffect = CONST_ANI_GLOOTHSPEAR, target = true},
	{name ="combat", interval = 2000, chance = 17, minDamage = 0, maxDamage = -170, range = 4, type = COMBAT_PHYSICALDAMAGE, shootEffect = CONST_ANI_GLOOTHSPEAR, target = true},
...
monster.defenses = {
	defense = 30,
	armor = 30,
	{name ="combat", interval = 2000, chance = 16, type = COMBAT_HEALING, minDamage = 200, maxDamage = 360, effect = CONST_ME_MAGIC_RED, target = false},
	...
	{name ="speed", interval = 2000, chance = 12, speed = 532, effect = CONST_ME_MAGIC_RED, target = false, duration = 4000}
}
