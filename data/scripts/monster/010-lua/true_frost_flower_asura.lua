...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 19, minDamage = -70, maxDamage = -270, length = 3, spread = 0, type = COMBAT_MANADRAIN, effect = CONST_ME_PURPLEENERGY, direction = true}, --purple beam
	{name ="combat", interval = 2000, chance = 35, minDamage = -450, maxDamage = -760, range = 5, type = COMBAT_ICEDAMAGE, effect = CONST_ME_ICEATTACK, shootEffect = CONST_ANI_ICE, target = true}, --ice strike
...
monster.defenses = {
	defense = 72,
	armor = 72,
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HEALING, minDamage = 150, maxDamage = 330}
}
