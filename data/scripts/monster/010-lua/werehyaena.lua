...
monster.attacks = {
    ...
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2*1000, chance = 15, minDamage = -250, maxDamage = -400, target = true, range = 5, radius = 1, shootEffect = CONST_ANI_LARGEROCK, effect = CONST_ME_MORTAREA},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2*1000, chance = 13, minDamage = -200, maxDamage = -300, length = 3, spread = 0, effect = CONST_ME_MORTAREA}
}
