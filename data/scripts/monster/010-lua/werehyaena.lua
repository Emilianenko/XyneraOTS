...
monster.attacks = {
    ...
    {name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2*1000, chance = 17, minDamage = -170, maxDamage = -270, radius = 3, effect = CONST_ME_HITBYPOISON},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2*1000, chance = 15, minDamage = -250, maxDamage = -400, range = 5, target = true, radius = 1, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2*1000, chance = 13, minDamage = -200, maxDamage = -300, length = 3, spread = 0, effect = CONST_ME_MORTAREA, direction = true}
}
