...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_HOLYDAMAGE, minDamage = -300, maxDamage = -410, range = 3, effect = CONST_ME_HOLYAREA, shootEffect = CONST_ANI_SMALLHOLY, target = true},
