...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -270, range = 5, type = COMBAT_PHYSICALDAMAGE, shootEffect = CONST_ANI_WHIRLWINDSWORD, target = true}
}
...
monster.loot = {
	...
	{id = 15488, chance = 30769},
	{id = 7591, chance = 23077},
	{id = 15426, chance = 15385},
	{id = 15425, chance = 11538},
	{id = 2168, chance = 7692}
}
