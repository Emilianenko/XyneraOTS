...
monster.name = "Squire Of Nictros"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -190, maxDamage = -335, range = 7, shootEffect = CONST_ANI_WHIRLWINDSWORD}
}
