...
EVENT_CALLBACK_ONINSPECTITEM = 29
EVENT_CALLBACK_ONINSPECTTRADEITEM = 30
EVENT_CALLBACK_ONINSPECTNPCTRADEITEM = 31
EVENT_CALLBACK_ONINSPECTCOMPENDIUMITEM = 32
EVENT_CALLBACK_ONINVENTORYUPDATE = 33

-- Monster
EVENT_CALLBACK_ONDROPLOOT = 34
EVENT_CALLBACK_ONSPAWN = 35
...
local callbacks = {
	...
	["onInspectItem"] = EVENT_CALLBACK_ONINSPECTITEM,
	["onInspectTradeItem"] = EVENT_CALLBACK_ONINSPECTTRADEITEM,
	["onInspectNpcTradeItem"] = EVENT_CALLBACK_ONINSPECTNPCTRADEITEM,
	["onInspectCompendiumItem"] = EVENT_CALLBACK_ONINSPECTCOMPENDIUMITEM,
