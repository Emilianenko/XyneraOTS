...
HirelingTradeList = {
	...
	["exercise weapons"] = {
		...
		{id = 31208, buy = 262500},
		{id = 31213, buy = 262500},
		{id = 37942, buy = 7560000},
		{id = 37944, buy = 7560000},
		{id = 37943, buy = 7560000},
		{id = 37945, buy = 7560000},
		{id = 37941, buy = 7560000},
		{id = 37946, buy = 7560000},
	}, -- unconfirmed
	["distance"] = {
		{id = 2544, buy = 3},
		{id = 38504, buy = 400},
	...
	if HirelingsUsageCache then
		...
		elseif msgcontains(msg, "trade") or msgcontains(msg, "goods") or msgcontains(msg, "selection") then
			if hasTrade then
				...
				npcHandler:say("I sell a {selection} of {various} items, {exercise weapons}, {distance} weapons, {wands} and {rods}, {potions}, {runes}, {supplies}, {backpack}, {tools} and {postal} goods. Just ask!", cid)
			else
				npc:openShopWindow(
					player,
